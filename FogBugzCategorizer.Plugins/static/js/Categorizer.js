...
var addSelectedTask, createProjectItem, createProjects, createSelectedProjectTask, createTaskItem, createTasks, getProjectTaskText;
...
createTaskItem = function(task) {
  ...
  div.html(task.Name).click(function(e) {
    ...
    if ($('#SelectedCategories div').filter(function() {
      return $(this).text() === getProjectTaskText(task);
    }).length < 1) {
