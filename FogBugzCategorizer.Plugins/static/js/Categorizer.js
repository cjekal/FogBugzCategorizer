...
var addSelectedTask, console, createProjectItem, createSelectedItem, createSelectedProjectTask, createTaskItem, createTasks, createTemplateDropdown, createTemplateItem, getProjectTaskText, getSelectedCategories, loadProjectsAndSelected;
...
loadProjectsAndSelected = function(isTemplateChanged, templateName) {
  var data;
...
createTemplateDropdown = function(container) {
  return $('<select id="selectedTemplate" name="selectedTemplate" style="display: block; visibility: visible;" />').appendTo(container).change(function(e) {
    e.preventDefault();
    console.log("changed template selection, new selected is " + ($(this).val()));
    return loadProjectsAndSelected(true, $(this).val());
  });
};
